...
{
    /**
     * Triples your String input and returns it. However, make the first instance lowercase,
     * the second uppercase, and third and final lowercase - just to mix things up!
     *
     * Ex:
