...
{
    /**
     * Given two characters, return true if the first letter parameter comes earlier in the alphabet
     * than the second letter parameter. Don't worry about casing, just turn consider everything in lowercase.
     *
     * Ex:
