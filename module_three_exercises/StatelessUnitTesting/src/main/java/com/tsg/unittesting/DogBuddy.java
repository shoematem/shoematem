...
{
    /**
     * Given a number of bones, this method returns the number of barks your dog will make. If there is an
     * even number of bones, your dog will bark three times. If there is an odd number, they'll bark twice!
     * If there are none, there is only a silence (ex: "..."), as it waits patiently for more bones!
     *
