...
{
    /**
     * Given the following chart, return the correct color designation given measured wavelength, frequency and photonic energy. 
     * If it doesn't fall within correct bands, return "Unknown" instead. If it falls exactly within a band transition, 
    ...
    public static String whatColor(int waveLengthNM, int frequencyTHZ, double photonicEnergyEV)
    {
        ...
        while(i < 2)
        {
            if((waveLengthNM < 380 || waveLengthNM > 750) && (frequencyTHZ < 400 || frequencyTHZ > 789) && (photonicEnergyEV < 1.65 || photonicEnergyEV > 3.26))
            {
                color = "Unknown";
                break;
            }
