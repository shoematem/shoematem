...
public class HappyLlamas
{
     ...
     *
     * When llamas get together they like to bounce on trampolines. However, llamas are very particular about the
     * proper number of trampolines, and are usually only happy if there are between 24 to 42 (inclusive!). This
     * only changes if the trampolines are made of ultra-bouncey NASA fabric. In those cases, while they still
     * require at LEAST 24, the llamas figure the more trampolines the better!
     * 
