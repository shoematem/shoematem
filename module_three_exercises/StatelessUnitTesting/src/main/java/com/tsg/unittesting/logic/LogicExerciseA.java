...
public class LogicExerciseA
{
     ...
     * 
     * It only likes to greet friends by name with a hearty hello, but strangers just get a simple quiet 'hi'.
     * Given the name of who's visiting, and a boolean of whether or not they're a friend, return the proper greeting.
